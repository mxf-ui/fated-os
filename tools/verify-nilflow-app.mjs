...
const fail = (message) => {
  console.error('[verify-nilflow] ' + message);
  process.exit(1);
};
...
[
  ...
  'function nilflowSetTab',
  'function nilflowStartMatch',
  'function nilflowAcceptMatch',
  'function nilflowRejectMatch',
  'function nilflowSendMessage',
  'function nilflowCreatePost',
  'function nilflowClearChats',
