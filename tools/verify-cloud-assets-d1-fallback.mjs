...
assert(/function getAssetBucket\(env\)/.test(assetApi) && /env && env\.ASSETS/.test(assetApi) && /typeof bucket\.put === 'function'/.test(assetApi), 'asset API should only use a real R2 ASSETS binding');
